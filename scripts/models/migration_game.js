define(function(require) {
	...
	return JsonBaseModel.extend({
		...
		migrate: function() {
			...
			console.log("owat", thing2);
			console.log("mmmmm", thing2.icon_thumbnail());
