<div style="text-align: center;">
	<a class="btn btn-link" data-toggle="collapse" href="#link_form" aria-expanded="false" aria-controls="collapseExample">
		  <%= gettext("Looking for your legacy games? Click here!") %>
	</a>
</div>
<div id="link_form" class="collapse">
